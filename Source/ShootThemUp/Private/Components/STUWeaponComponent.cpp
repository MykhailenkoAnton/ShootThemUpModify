...
void USTUWeaponComponent::InitAnimations()
{
    ...
    const auto NotifiesEvents = EquipAnimMontage->Notifies;
    for (auto NotifiyEvent : NotifiesEvents)
    {
        auto EquipFinishNotify = Cast<USTUEquipFinishedAnimNotify>(NotifiyEvent.Notify);
...
{
    return EquipAnimInProgress == false; // !EquipAnimInProgress;
}
