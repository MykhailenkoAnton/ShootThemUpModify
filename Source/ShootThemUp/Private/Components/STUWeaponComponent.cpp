...
void USTUWeaponComponent::InitAnimations()
{
    ...
    {
        UE_LOG(LogWeaponComponent, Error, TEXT("No equip anim"));
        checkNoEntry();
    }
...
{
    return EquipAnimInProgress == false && !ReloadAnimInProgress;  // !EquipAnimInProgress;
}
...
bool USTUWeaponComponent::GeCurrenttWeaponUIData(FWeaponUIData& UIData) const
{
    if (CurrentWeapon)
    {
...
bool USTUWeaponComponent::TyToAddAmmo(TSubclassOf<ASTUBaseWeapon> WeaponType, int32 ClipsAmount) 
{
    for (const auto Weapon : Weapons)
    {
